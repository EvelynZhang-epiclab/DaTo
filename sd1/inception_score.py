...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return image
# 指定文件路径
file_path = '/dockerdata/yuuweizhang/projects/sd2/outputs/tome/coco30k/IS.txt'
os.makedirs(os.path.dirname(file_path), exist_ok=True)

x_values= [0.3,0.4,0.5,0.6,0.7]
for x in x_values:
    #设置数据路径
    data_path =f'/dockerdata/yuuweizhang/projects/sd2/outputs/tome/coco30k/ratio_{x}/samples'
    # 加载图片数据集
