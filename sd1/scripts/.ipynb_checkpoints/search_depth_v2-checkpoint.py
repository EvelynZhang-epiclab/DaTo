...
# CUDA_VISIBLE_DEVICES=2 python scripts/search_depth_v2.py
root_dir= '/dockerdata/yuuweizhang/projects/sd1/outputs/search_depth/v2'
...
algorithm = NSGA2(
    pop_size=20,
    sampling=ConstrainedSampling(steps=50, max1=4,max2=6,max3=4),
