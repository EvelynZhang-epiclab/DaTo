...
# CUDA_VISIBLE_DEVICES=0 python scripts/search_depth_v0.py
root_dir= '/dockerdata/yuuweizhang/projects/sd1/outputs/search_depth/v0'
...
algorithm = NSGA2(
    pop_size=20,
    sampling=ConstrainedSampling(steps=50, max1=2,max2=3,max3=2),
