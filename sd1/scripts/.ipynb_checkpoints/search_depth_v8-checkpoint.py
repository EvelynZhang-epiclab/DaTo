...
# CUDA_VISIBLE_DEVICES=0 python scripts/search_depth_v8.py
root_dir= '/dockerdata/yuuweizhang/projects/sd1/outputs/search_depth/v8'
...
algorithm = NSGA2(
    pop_size=20,
    sampling=ConstrainedSampling(steps=50, max1=8,max2=9,max3=8),
