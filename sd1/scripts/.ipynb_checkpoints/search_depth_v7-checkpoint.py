...
# CUDA_VISIBLE_DEVICES=7 python scripts/search_depth_v7.py
root_dir= '/dockerdata/yuuweizhang/projects/sd1/outputs/search_depth/v7'
...
class ConstrainedSampling(Sampling):
    ...
    def generate_individual(self):
        ...
        max2 = np.random.randint(2,self.max2)
...
class DiffusionOptimizationProblem(Problem): 
    ...
    def _evaluate(self, X, out, *args, **kwargs):
        ...
        # 定义目标函数
        out["F"] = np.column_stack([-rewards*100, total_times*100])
        # 定义约束条件
        out["G"] = -rewards
