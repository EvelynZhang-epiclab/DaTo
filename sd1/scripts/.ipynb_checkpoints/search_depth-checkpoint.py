...
# CUDA_VISIBLE_DEVICES=4 python scripts/search_depth_v9.py
root_dir= '/path/to/sd1/outputs/search_depth/v9'
...
class ConstrainedSampling(Sampling):
    ...
    def generate_individual(self):
        ...
        max1 = np.random.randint(0,self.max1)
        # 第一层：15个元素，最多5个12
        ...
        max2 = np.random.randint(0,self.max2)
        ...
        # 第三层：15个元素，最多5个12
        max3 = random.randint(0,self.max3)
...
def calculate_fid_and_cache_id(cache_strategy):
    ...
    input_file="/path/to/projects/sd1/imagenet.txt"
...
algorithm = NSGA2(
    pop_size=15,
    sampling=ConstrainedSampling(steps=50, max1=1,max2=2,max3=1),
